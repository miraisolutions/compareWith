...
Meld is not yet officially supported on **MacOS**. However, it can be installed via MacPorts, Fink or Brew, making sure `meld` can be launched from the command line.
